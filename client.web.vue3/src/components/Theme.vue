 ...
 * @LastEditors: snltty
 * @LastEditTime: 2021-08-20 14:50:42
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.web.vue3\src\components\Theme.vue
-->
<template>
    <el-color-picker v-model="color" size="mini" style="margin-left:1rem"></el-color-picker>
</template>
