...
namespace rdp.desktop
{
    public class RdpShareSettingViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        private string serverConnectString = string.Empty;
        public string ServerConnectString
        {
            get => serverConnectString;
            set
            {
                serverConnectString = value;
                RaisePropertyChanged(() => ServerConnectString);
            }
        }
        ...
        private string clientConnectString = string.Empty;
        public string ClientConnectString
        {
            get => clientConnectString;
            set
            {
                clientConnectString = value;
                RaisePropertyChanged(() => ClientConnectString);
            }
        }
